        ...
        while cap.isOpened():
            ...
            if results.multi_hand_landmarks:
                ...
                for hand_landmarks,handedness in zip(results.multi_hand_landmarks,results.multi_handedness):
                    ...
                    cv2.rectangle(frame,(rect_coordinates[0],rect_coordinates[1]),(rect_coordinates[2],rect_coordinates[3]),(255,123,50),1)
                    ...
                    #drawing info text
                    if mode == 0:
                        info_text(frame,handedness,keypoint_labels[hand_sign_id],rect_coordinates)
...
def display_info(frame,mode):
    ...
    if mode == 0:
        cv2.putText(frame, start_text,(10,50),cv2.FONT_HERSHEY_COMPLEX,0.5,(250,220,150))
    if mode == 1:
        cv2.putText(frame, keying,(10,50),cv2.FONT_HERSHEY_COMPLEX,0.5,(250,220,150))
        cv2.putText(frame, instruction,(10,70),cv2.FONT_HERSHEY_COMPLEX,0.5,(250,220,150))
        cv2.putText(frame, revert, (10,400), cv2.FONT_HERSHEY_SIMPLEX,0.7,(0,250,200))
